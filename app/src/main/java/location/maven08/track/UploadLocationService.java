    ...
    protected void onHandleIntent(@Nullable Intent intent) {
        if (intent != null) {
            ...
            if (b != null) {
                ...
                URL url;
                try {
                    Toast.makeText(this,"lat: "+points.get(0).getLongitude() +" long: "+points.get(0).getLatitude(),Toast.LENGTH_LONG).show();
//                    url = new URL("http://localhost:8000/trackme/update"); // set your server url
//                    sendLocation(url, "");
                } catch (Exception e) {
                    e.printStackTrace();
                }
